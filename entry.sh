...
# raspivid -o - -t 0 -w 1280 -h 720 -fps 25 -b 2000000 | ffmpeg -re -f s16le -i /dev/zero -f h264 -i pipe:0 -c:v copy -f fifo -fifo_format flv -map 0:v -map 0:a -drop_pkts_on_overflow 1 -attempt_recovery 1 -recovery_wait_time 1 -recover_any_error 1 rtmp://a.rtmp.youtube.com/live2/$1
